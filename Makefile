...
RV_FLAGS   := -march=rv64gcv -mabi=lp64d -static -I./include -I$(GTEST_INC)
...
.PHONY: all clean run_all rvv_test hello_test
...
#  RVV ( Vector)
# RVV ( Vector) Linker  main
rvv_test:
	mkdir -p $(BUILD_RV)
	$(CXX) $(RV_FLAGS) $(RV_DEFINES) tests/rvv_test.cpp $(GTEST_LIB) -o $(BUILD_RV)/rvv_test -Wl,--undefined=main
